...
#model_id_alt = 'stabilityai/stable-diffusion-2-1-base'  # PNDMScheduler
#model_id_alt = 'Kandinski'  # PNDMScheduler
#model_id_alt = 'runwayml/stable-diffusion-v1-5'  # PNDMScheduler
#model_id_alt = 'prompthero/openjourney'  # PNDMScheduler, torch_dtype=torch.float16
#model_id_alt = 'Fictiverse/Stable_Diffusion_Microscopic_model'  # PNDMScheduler
#model_id_alt = 'dalle-mini/dalle-mega'  # PNDMScheduler
#model_id_alt = "hakurei/waifu-diffusion"
...
f1 = row[f'FFT(wchannel)   BASE=gen_w   PIPE=alt   INV_PROMPT=unknown_prompt']
print('####################################')
print('####################################')
print('####################################')
print((f0 - f1).sum())
